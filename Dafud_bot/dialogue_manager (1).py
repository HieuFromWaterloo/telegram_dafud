...
class ThreadRanker(object):
    def __init__(self, RESOURCE_PATH):
        self.word_embeddings, self.embeddings_dim = load_embeddings(RESOURCE_PATH['WORD_EMBEDDINGS'])
...
class DialogueManager(object):
    ...
    def generate_answer(self, question):
        ...
        if intent == 'dialogue':
            ...
            response = "How may I help you with your programming struggles today? "  # YOUR CODE HERE ####
            return response
