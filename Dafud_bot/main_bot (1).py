...
class BotHandler(object):
    ...
    def get_answer(self, question):
        if question == '/start':
            return "Hi, I am your final project bot. What's popping lad?"
...
def main():
    token = ':AAH_pAE0rkD4gigtAbyeqL'  # fake token for submission
            ...
            if "message" in update:
                ...
                if "text" in update["message"]:
                    ...
                    if is_unicode(text):
                        ...
                        bot.send_message(chat_id, "Hmm, you are sending some weird shit that makes no sense...")
